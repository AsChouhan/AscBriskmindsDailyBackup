...
import objectName from '@salesforce/schema/CaseCustom__c';
...
import status from '@salesforce/schema/CaseCustom__c.Status__c';
...
export default class CaseCustom extends LightningElement {
    ...
    addRowMethod() {
        var newRow = { Id: this.countId, attributes: { "type": "CaseCustom__c" } };
